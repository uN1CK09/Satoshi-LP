...
public class Lt01_DecEx23 {
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, "OS VALORES 1, 2 E 3 DEVEM SER INSERIDOS EM ORDEM CRESCENTE");
        ...
        if (v1 > v2) {
                JOptionPane.showMessageDialog(null, "Valor 2 é menor que valor 1");
            }
        else {
                v3 = Integer.parseInt(JOptionPane.showInputDialog(null, "Insira o terceiro valor"));
                if (v2 > v3) {
                        JOptionPane.showMessageDialog(null, "Valor 3 é menor que valor 2");
                    }
                else {
